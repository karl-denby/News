...
public final class QueryUtils {
    ...
    // Sample JSON response for a Guardian API query
    ...
    public static ArrayList<Story> extractStories(String query_results) {
        ...
        try {
            ...
            for (int i = 0; i < storyArray.length(); i++) {
                ...
                // Extract authors a.k.a byline in this api
                String author = fields.getString("byline");

                // Create a new {@link Story} object with the title/author/url from the response.
                Story story = new Story(headline, author, url);

                // Add the new {@link Story} to the list of books.
                stories.add(story);
            }
